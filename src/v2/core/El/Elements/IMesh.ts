import { BufferGeometry, Clock, Color, Event, Material, Mesh, MeshStandardMaterial, Object3D, Vector3 } from "three";
  ...
  mount(scene: IScene) {
    ...
    if (this.scene?.core?.world) {
      ...
      if (this.shape) {
        ...
        this.scene.core.world.addBody(this.body)
      }
    }
  }
